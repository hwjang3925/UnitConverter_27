...
| 02 | `test/acceptance-red` | 외부 Red | 실패하는 인수 테스트만 존재 |
| 03 | `feat/basic-green` | 내부 RGR | AT-1~AT-5 Green |
| 04 | `feat/extras` | 외부+내부 반복 | 추가 요구 3건 Green |
| 05 | `docs/retro` | 회고 | 발표/회고 정리 |
...
**01 spec 완료** → `test/acceptance-red` 브랜치 생성 후 02단계 진행
